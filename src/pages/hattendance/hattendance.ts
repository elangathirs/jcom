...
@Component({
  selector: 'page-hattendance',
  templateUrl: 'hattendance.html',
})
export class HattendancePage {
  ...
  load(){
    ...
    let body: string = "?m_id="+m_id,
      url: any = this.baseURI + "get_attendance_history.php" + body;
      this.http.get(url).map(res => res.json()).subscribe(data => {
            this.attendance_history = data;
            console.log("Hconnect data :",this.attendance_history);
